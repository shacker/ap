...
ADMINS = [
    ('Scot Hacker', 'shacker@athlete.photo'),
]
MANAGERS = ADMINS
...
COMPRESS_PRECOMPILERS = (
    ...
    # Would only be used if we wanted compressor to compile React, rather than webpack
    # FIXME: this can be removed if we don't use compressor to compile react
...
# Logging configuration. On CI and prod, all log messages emitted to console
# show up at logentries.com in the "uwsgi" bucket.
LOGGING = {
    'version': 1,
...
# Google Places api used in the Claimform and is currently tied to bkremer@energy-solution.com
GOOGLE_PLACES_API_KEY = 'AIzaSyDYWCwNO3V9YmKUAdTKHIpPEcicixyC7lA'
